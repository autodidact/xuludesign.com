...
function Wave(wh, ww, color) {
    ...
    this.Initialize = function() {
        ...
        this.particles = Array(params.no_particles);
        this.InitParticles();
    ...
    this.Draw = function(context) {
        ...
        context.closePath();
        //var grad = context.createLinearGradient(0, this.particles[0].y, 0, HEIGHT);
